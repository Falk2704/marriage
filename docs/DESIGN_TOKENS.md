...
| Token       | Hex       | RGB              | Usage                                                      |
| ----------- | --------- | ---------------- | ---------------------------------------------------------- |
| `primary`   | `#4F6F5B` | `79, 111, 91`    | All text, headings, nav, dividers, illustration, accents   |
| `bg`        | `#F4F1E8` | `244, 241, 232`  | Main page background (warm ivory)                          |
| `bg-alt`    | `#E9E4D6` | `233, 228, 214`  | Alternating section backgrounds                            |
| `accent`    | `#6F8F78` | `111, 143, 120`  | Hover states, links on hover, subtle UI highlights         |
